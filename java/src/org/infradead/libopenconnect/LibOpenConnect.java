...
public abstract class LibOpenConnect {
	...
	public static final int MAINLOOP_DONE = 0;
	public static final int MAINLOOP_PAUSED = 1;
	...
	public synchronized native void setCSDWrapper(String wrapper, String tmpDir);
